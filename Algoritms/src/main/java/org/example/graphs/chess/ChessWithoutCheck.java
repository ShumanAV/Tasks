...
public class ChessWithoutCheck {
    ...
    // Можно ради любопытства менять координаты выхода, сравнивать время работы алгоритма с алгоритмом с проверками,
    // оно достаточно сильно отличается при больших значениях
