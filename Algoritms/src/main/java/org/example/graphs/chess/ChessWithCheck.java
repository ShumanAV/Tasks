...
public class ChessWithCheck {
    ...
    // Можно ради любопытства менять координаты выхода и границы поля, сравнивать время работы алгоритма с алгоритмом
    // без проверок, оно достаточно сильно отличается
